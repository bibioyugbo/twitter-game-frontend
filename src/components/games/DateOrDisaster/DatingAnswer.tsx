...
export default function DatingAnswer (){
    ...
    const shareWithImage = async () => {
        ...
        if (navigator.canShare && navigator.canShare({ files: [file] })) {
            ...
            alert("Image sharing not supported on this device/browser.");
        }
    };
            ...
            <DateOrDisasterWrapper>
                {
                    ...
                    <div className={"flex gap-4 flex-col w-full items-center"}>
                        ...
                        <div className={"flex gap-2 mt-8"}>
                            ...
                            {/*</button>*/}
                            <button onClick={shareWithImage} className={"bg-[#0D0735] cursor-pointer hover:scale-105 transition-transform flex justify-center rounded-[64px] h-[64px] w-[64px]"}>
                                <img src={shareImg} height={30} width={30} alt={""}/>
                            </button>
                            <button onClick={downloadResult} className={"bg-[#0D0735] cursor-pointer hover:scale-105 transition-transform flex justify-center rounded-[64px] h-[64px] w-[64px]"}>
